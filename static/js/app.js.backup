...
async function uploadAudioFile(file) {
    ...
    try {
        ...
        if (data.success) {
            addMessageToChat('assistant', `Success! Audio processed successfully! I've created a detailed report with transcription and analysis. You can view it in the Reports section.`);
